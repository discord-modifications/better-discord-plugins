/**
 * @name DoubleClickVC
 * @source https://github.com/discord-modifications/better-discord-plugins/blob/master/DoubleClickVC/DoubleClickVC.plugin.js
 * @updateUrl https://raw.githubusercontent.com/discord-modifications/better-discord-plugins/master/DoubleClickVC/DoubleClickVC.plugin.js
 * @website https://github.com/discord-modifications/better-discord-plugins/tree/master/DoubleClickVC/DoubleClickVC.plugin.js
...
module.exports = (() => {
   const config = {
      info: {
         ...
         version: '1.0.0',
         description: 'Requires you to double click voice channels to join them instead of single clicking.',
         github: 'https://github.com/eternal404',
         github_raw: 'https://raw.githubusercontent.com/discord-modifications/better-discord-plugins/master/DoubleClickVC/DoubleClickVC.plugin.js'
      },
   };
   ...
   return !global.ZeresPluginLibrary ? class {
      ...
      return class extends Plugin {
         start() {
            ...
            Patcher.after(ChannelItem, 'default', (_, [{ channel }], res) => {
               if (channel.type !== 2) return res;

               const clickable = Utilities.findInReactTree(res, r => r?.onClick);
               if (clickable) {
            ...
            const Mention = WebpackModules.find(m => m.default?.displayName === 'Mention');
            Patcher.after(Mention, 'default', (_, [{ iconType }], res) => {
               if (iconType === 'voice') {
