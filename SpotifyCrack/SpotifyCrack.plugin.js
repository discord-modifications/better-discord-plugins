/**
 * @name SpotifyCrack
 * @source https://github.com/discord-modifications/better-discord-plugins/blob/master/SpotifyCrack/SpotifyCrack.plugin.js
 * @updateUrl https://raw.githubusercontent.com/discord-modifications/better-discord-plugins/master/SpotifyCrack/SpotifyCrack.plugin.js
 * @website https://github.com/discord-modifications/better-discord-plugins/tree/master/SpotifyCrack/SpotifyCrack.plugin.js
...
module.exports = (() => {
   const config = {
      info: {
         ...
         github_raw: 'https://raw.githubusercontent.com/discord-modifications/better-discord-plugins/master/SpotifyCrack/SpotifyCrack.plugin.js'
      },
      changelog: [
         {
            title: 'Fixed',
