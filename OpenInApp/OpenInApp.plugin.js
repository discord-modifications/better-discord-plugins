/**
 * @name OpenInApp
 * @source https://github.com/discord-modifications/better-discord-plugins/blob/master/OpenInApp/OpenInApp.plugin.js
 * @updateUrl https://raw.githubusercontent.com/discord-modifications/better-discord-plugins/master/OpenInApp/OpenInApp.plugin.js
 * @website https://github.com/discord-modifications/better-discord-plugins/tree/master/OpenInApp/OpenInApp.plugin.js
...
module.exports = (() => {
   ...
   const config = {
      info: {
         ...
         github_raw: 'https://raw.githubusercontent.com/discord-modifications/better-discord-plugins/master/OpenInApp/OpenInApp.plugin.js'
      },
      changelog: [
         {
            title: 'Fixed',
