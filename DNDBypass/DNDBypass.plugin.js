/**
 * @name DNDBypass
 * @source https://github.com/discord-modifications/better-discord-plugins/blob/master/DNDBypass/DNDBypass.plugin.js
 * @updateUrl https://raw.githubusercontent.com/discord-modifications/better-discord-plugins/master/DNDBypass/DNDBypass.plugin.js
 * @website https://github.com/discord-modifications/better-discord-plugins/tree/master/DNDBypass/DNDBypass.plugin.js
...
module.exports = (() => {
   const config = {
      info: {
         ...
         github_raw: 'https://raw.githubusercontent.com/discord-modifications/better-discord-plugins/master/DNDBypass/DNDBypass.plugin.js'
      },
      changelog: [
         {
            title: 'Fixed',
